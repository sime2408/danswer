...
const Main = () => {
  ...
  return (
    <div className="mb-8">
      ...
      <Text className="mb-2">
        Setup a Slack bot that connects to Adcubum. Once setup, you will be able
        to ask questions to Adcubum directly from Slack. Additionally, you can:
      </Text>
      ...
      <Text className="mb-6">
        ...
        found in the Adcubum documentation to get started!
      </Text>
      ...
      {slackBotTokens && (
        <>
          ...
          <Text className="mb-3">
            Configure Adcubum to automatically answer questions in Slack
            channels. By default, Adcubum only responds in channels where a
