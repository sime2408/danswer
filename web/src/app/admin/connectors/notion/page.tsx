      ...
      {notionCredential ? (
        ...
        <>
          <Text>
            ...
            Notion for Adcubum. Follow the instructions in the&nbsp;
            <a
            ...
            Notion docs to allow Adcubum to read Notion Databases and Pages
            ...
            <CredentialForm<NotionCredentialJson>
              ...
              validationSchema={Yup.object().shape({
                notion_integration_token: Yup.string().required(
                  "Please enter the Notion Integration token for the Adcubum integration."
                ),
              })}
              initialValues={{
